...
//                 label: 'From Date',
//                 firstDate: _tempFilter.dateRange?.startDate,
//                 onDateSelected: (date) {
//                   setState(() {
...
//               child: DatePickerField(
//                 label: 'To Date',
//                 firstDate: _tempFilter.dateRange?.endDate,
//                 onDateSelected: (date) {
//                   setState(() {
//                     final startDate = _tempFilter.dateRange?.startDate ?? date;
//                     _tempFilter = _tempFilter.copyWith(
//                       // dateRange: DateRange(
...
//             // onChanged: (value) {
//             //   _tempFilter = _tempFilter.copyWith(minAmount: value);
//             // },
//           ),
//         ),
//         const SizedBox(width: 16),
...
//             // onChanged: (value) {
//             //   _tempFilter = _tempFilter.copyWith(maxAmount: value);
//             // },
//           ),
//         ),
//       ],
